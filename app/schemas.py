...
class PortfolioAdviceOut(BaseModel):
    ...
    market_breadth_20d: float | None = None
    market_breadth_60d: float | None = None
    market_avg_momentum_20d: float | None = None
    market_amount_trend: float | None = None
    market_volatility_20d: float | None = None
    adaptive_note: str | None = None
    effective_buy_score_threshold: float | None = None
    score_weight_alpha: float | None = None
    score_weight_fundamental: float | None = None
    score_weight_valuation: float | None = None
    score_weight_liquidity: float | None = None
    score_weight_risk: float | None = None
    recommendation_tier: str | None = None
    signal_source: str | None = None
    strategy_scores: dict[str, dict[str, Any]] | None = None
    short_score: float | None = None
    short_action: str | None = None
    short_confidence: str | None = None
    short_trade_date: str | None = None
    short_model_version: str | None = None
    mid_long_score: float | None = None
    mid_long_action: str | None = None
    mid_long_confidence: str | None = None
    mid_long_trade_date: str | None = None
    mid_long_model_version: str | None = None
    advice_reason: str
...
class StrategyConfigIn(BaseModel):
    strategy_type: str = Field(default="short_elastic_2_8w", pattern="^(short_elastic_2_8w|mid_long_quality_3_12m)$")
